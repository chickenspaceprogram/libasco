...
asco_save:; Function begin
        ...
        mov     qword [rcx], r11                        ; 004E _ 4C: 89. 19
        mov     qword [rcx+10H], rsp                    ; 0051 _ 48: 89. 61, 10
        push    r11                                     ; 0055 _ 41: 53
        mov     qword [rcx+8H], rbp                     ; 0057 _ 48: 89. 69, 08
        stmxcsr dword [rcx+18H]                         ; 005B _ 0F AE. 59, 18
        fwait                                           ; 005F _ 9B
        fnstcw  word [rcx+1CH]                          ; 0060 _ D9. 79, 1C
        mov     qword [rcx+20H], rbx                    ; 0063 _ 48: 89. 59, 20
        mov     qword [rcx+28H], r12                    ; 0067 _ 4C: 89. 61, 28
        mov     qword [rcx+30H], r13                    ; 006B _ 4C: 89. 69, 30
        mov     qword [rcx+38H], r14                    ; 006F _ 4C: 89. 71, 38
        mov     qword [rcx+40H], r15                    ; 0073 _ 4C: 89. 79, 40
        mov     qword [rcx+48H], rdi                    ; 0077 _ 48: 89. 79, 48
        mov     qword [rcx+50H], rsi                    ; 007B _ 48: 89. 71, 50
        movdqu  oword [rcx+58H], xmm6                   ; 007F _ F3: 0F 7F. 71, 58
        movdqu  oword [rcx+68H], xmm7                   ; 0084 _ F3: 0F 7F. 79, 68
        movdqu  oword [rcx+78H], xmm8                   ; 0089 _ F3 44: 0F 7F. 41, 78
        movdqu  oword [rcx+88H], xmm9                   ; 008F _ F3 44: 0F 7F. 89, 00000088
        movdqu  oword [rcx+98H], xmm10                  ; 0098 _ F3 44: 0F 7F. 91, 00000098
        movdqu  oword [rcx+0A8H], xmm11                 ; 00A1 _ F3 44: 0F 7F. 99, 000000A8
        movdqu  oword [rcx+0B8H], xmm12                 ; 00AA _ F3 44: 0F 7F. A1, 000000B8
        movdqu  oword [rcx+0C8H], xmm13                 ; 00B3 _ F3 44: 0F 7F. A9, 000000C8
        movdqu  oword [rcx+0D8H], xmm14                 ; 00BC _ F3 44: 0F 7F. B1, 000000D8
        movdqu  oword [rcx+0E8H], xmm15                 ; 00C5 _ F3 44: 0F 7F. B9, 000000E8
...
asco_load:; Function begin
        mov     r11, qword [rcx]                        ; 0111 _ 4C: 8B. 19
        mov     rbp, qword [rcx+8H]                     ; 0114 _ 48: 8B. 69, 08
        mov     rsp, qword [rcx+10H]                    ; 0118 _ 48: 8B. 61, 10
        ldmxcsr dword [rcx+18H]                         ; 011C _ 0F AE. 51, 18
        fwait                                           ; 0120 _ 9B
        fnclex                                          ; 0121 _ DB. E2
        fldcw   word [rcx+1CH]                          ; 0123 _ D9. 69, 1C
        mov     rbx, qword [rcx+20H]                    ; 0126 _ 48: 8B. 59, 20
        mov     r12, qword [rcx+28H]                    ; 012A _ 4C: 8B. 61, 28
        mov     r13, qword [rcx+30H]                    ; 012E _ 4C: 8B. 69, 30
        mov     r14, qword [rcx+38H]                    ; 0132 _ 4C: 8B. 71, 38
        mov     r15, qword [rcx+40H]                    ; 0136 _ 4C: 8B. 79, 40
        mov     rdi, qword [rcx+48H]                    ; 013A _ 48: 8B. 79, 48
        mov     rsi, qword [rcx+50H]                    ; 013E _ 48: 8B. 71, 50
        movdqu  xmm6, oword [rcx+58H]                   ; 0142 _ F3: 0F 6F. 71, 58
        movdqu  xmm7, oword [rcx+68H]                   ; 0147 _ F3: 0F 6F. 79, 68
        movdqu  xmm8, oword [rcx+78H]                   ; 014C _ F3 44: 0F 6F. 41, 78
        movdqu  xmm9, oword [rcx+88H]                   ; 0152 _ F3 44: 0F 6F. 89, 00000088
        movdqu  xmm10, oword [rcx+98H]                  ; 015B _ F3 44: 0F 6F. 91, 00000098
        movdqu  xmm11, oword [rcx+0A8H]                 ; 0164 _ F3 44: 0F 6F. 99, 000000A8
        movdqu  xmm12, oword [rcx+0B8H]                 ; 016D _ F3 44: 0F 6F. A1, 000000B8
