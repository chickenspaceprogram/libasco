...
; Note: Absolute memory address without relocation
        ...
        push    qword [r10+20H]                         ; 00AF _ 41: FF. 72, 20
        push    qword [r10+1478H]                       ; 00B3 _ 41: FF. B2, 00001478
        sub     rsp, 160                                ; 00BA _ 48: 81. EC, 000000A0
        movdqu  oword [rsp], xmm6                       ; 00C1 _ F3: 0F 7F. 34 24
        movdqu  oword [rsp+10H], xmm7                   ; 00C6 _ F3: 0F 7F. 7C 24, 10
        movdqu  oword [rsp+20H], xmm8                   ; 00CC _ F3 44: 0F 7F. 44 24, 20
        movdqu  oword [rsp+30H], xmm9                   ; 00D3 _ F3 44: 0F 7F. 4C 24, 30
        movdqu  oword [rsp+40H], xmm10                  ; 00DA _ F3 44: 0F 7F. 54 24, 40
        movdqu  oword [rsp+50H], xmm11                  ; 00E1 _ F3 44: 0F 7F. 5C 24, 50
        movdqu  oword [rsp+60H], xmm12                  ; 00E8 _ F3 44: 0F 7F. 64 24, 60
        movdqu  oword [rsp+70H], xmm13                  ; 00EF _ F3 44: 0F 7F. 6C 24, 70
        movdqu  oword [rsp+80H], xmm14                  ; 00F6 _ F3 44: 0F 7F. B4 24, 00000080
